...
#define LED4_BRIGHTNESS 0x0B    // Contains the brightness level for LED 4 (only on the LP5018)
#define LED5_BRIGHTNESS 0x0C    // Contains the brightness level for LED 5 (only on the LP5018)
#define LED6_BRIGHTNESS 0x0D    // Contains the brightness level for LED 6 (only on the LP5024)
#define LED7_BRIGHTNESS 0x0E    // Contains the brightness level for LED 7 (only on the LP5024)
